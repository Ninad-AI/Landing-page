      ...
      {plans.map((plan, index) => {
        ...
        return (
          <button
            ...
            disabled={disabled}
            className={`${isBottomRow ? "col-span-3" : "col-span-2"} h-[62px] sm:h-[68px] rounded-xl sm:rounded-2xl border transition-all duration-300 flex flex-col items-center justify-center ${isSelected ? "border-white bg-white/10 text-white shadow-lg" : "border-white/20 bg-white/5 text-white/70 hover:border-white/50"} disabled:opacity-60 disabled:cursor-not-allowed`}
          >
