              ...
              <div className="w-full animate-fade-in-up flex flex-col items-center gap-4 sm:gap-5 mt-1 sm:mt-2">
                ...
                <div className="w-full flex justify-center pt-1 sm:pt-2">
                  <button
                    ...
                    disabled={!selectedDuration || isBusy}
                    className={`w-[86%] sm:w-[320px] h-[64px] rounded-2xl font-semibold text-lg transition-all duration-500 ${selectedDuration ? "bg-gradient-to-r from-pink-500 via-red-500 to-orange-500 text-white shadow-[0_10px_40px_rgba(255,80,80,0.35)] hover:scale-[1.02]" : "bg-white/10 text-white/30 border border-white/10"} disabled:cursor-not-allowed disabled:opacity-70`}
                  >
                    {isVerifyingPayment
                      ? "Verifying Payment..."
                      : isCreatingOrder
