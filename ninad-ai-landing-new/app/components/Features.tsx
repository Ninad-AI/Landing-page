const STEPS = [
  { n: "01", title: "You speak", body: "Hold the button and talk the way you would to a person. Hindi, Tamil, or all three in one sentence." },
  { n: "02", title: "We transcribe", body: "Speech-to-text tuned for Indian accents and code-switching, not a US-English model with a shrug." },
  { n: "03", title: "The persona thinks", body: "A model grounded in that figure's own corpus, behind a versioned system prompt and live guardrails." },
  { n: "04", title: "They answer", body: "Their licensed voice, streaming back word by word. You hear the reply while it forms." },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-[.9fr_1.1fr] gap-10 md:gap-16 items-start">
          <div className="md:sticky md:top-28">
            ...
            <h2 className="font-display text-[36px] sm:text-[44px] leading-[1.05] tracking-tight mb-3.5">
              Four steps, a second and a half.
            </h2>
