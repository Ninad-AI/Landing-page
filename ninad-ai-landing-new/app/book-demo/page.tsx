    ...
    <main className="relative h-[100svh] overflow-hidden bg-black">
      <section className="relative w-full h-[100svh] pt-28 md:pt-32 flex items-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12 lg:px-20">
          <div className="mx-auto w-full max-w-6xl -translate-y-4 md:-translate-y-6">
            ...
            <div className="max-w-2xl">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <Link
                  href="/"
                  className="inline-flex items-center justify-center px-5 py-2.5 rounded-full border border-white/15 text-white/80 hover:text-white hover:border-white/25 transition-colors"
                >
                  Back to home
                </Link>
                <Link
